...
class RestaurantTest {
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time() {
        ...
        when(restaurantSpy.getCurrentTime()).thenReturn(LocalTime.parse("11:00:00"));
    ...
    public void is_restaurant_open_should_return_false_if_time_is_outside_opening_and_closing_time() {
        Restaurant restaurantSpy = Mockito.spy(restaurant);
        when(restaurantSpy.getCurrentTime()).thenReturn(LocalTime.parse("23:00:00"));
    ...
    public void selected_menu_items_should_result_the_total_price_correctly() {
        ...
        assertEquals(388, restaurant.totalItemsCost(itemsSelected));
    }
    //<<<<<<<<<<<<<<<<<<<<<<<MENU>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
}